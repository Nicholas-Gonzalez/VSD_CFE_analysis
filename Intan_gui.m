...
% video params
% ------------------------------
uicontrol('Units','normalized','Position',[0.11 0.89 0.08 0.03],'Style','text',...
    'String','Frame interval (ms)','HorizontalAlignment','right','Enable','on');

uicontrol('Units','normalized','Position',[0.2 0.90 0.06 0.03],'Style','edit',...
...
for i=1:10
    ...
    uicontrol('Units','normalized','Position',[0.06 y-0.005 0.02 height],'Style','checkbox',...
        'Tag',['instrumentchk_' num2str(i)],'HorizontalAlignment','center','Value',chkv,...
        'Enable','on','callback',@use_instrument);
    uicontrol('Units','normalized','Position',[0.09 y 0.07 height-0.01],'Style','edit',...
        'Tag',['instrument' num2str(i)],'String','A0-G8','HorizontalAlignment','center',...
        'Enable',enable);
    uicontrol('Units','normalized','Position',[0.16 y 0.07 height-0.01],'Style','edit',...
        'Tag',['instrument' num2str(i)],'String',['1-' num2str(length(vch))],'HorizontalAlignment','center',...
        'Enable',enable);
    uicontrol('Units','normalized','Position',[0.23 y-0.01 0.06 height],'Style','popupmenu',...
        'Tag',['instrument' num2str(i)],'String',instruments,'Value',instr,'HorizontalAlignment','center',...
        'Enable',enable);
end

nax = axes('units','normalized','Position',[0.02 0.42 0.27 0.10]);
% notes = [repmat('CDEFGAB',1,8)', num2str(repelem(1:8,7)')];
pitch = repmat(["C" "D" "E" "F" "G" "A" "B"],1,9);
