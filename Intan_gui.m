...
uicontrol('Position',[1220 330 100 20],'Style','pushbutton','Tag','adjust',...
...
switch hband.Tag
    case 'lowpass'
        h = fdesign.lowpass('N,Fp,Fst,Ap,Ast', 1, fpass(2), fstop(2), fr, fatt(2), diff(props.tm(1:2))^-1);
    case 'bandpass'      
        h = fdesign.bandpass('N,Fst1,Fp1,Fp2,Fst2,Ast1,Ap,Ast2', 1, fstop(1), fpass(1), ...
            fpass(2), fstop(2), fatt(1), fr, fatt(2), diff(props.tm(1:2))^-1);
    case 'highpass'
        h = fdesign.highpass('N,Fst,Fp,Ast,Ap',1, fstop(1), fpass(1), fatt(1), fr, diff(props.tm(1:2))^-1);
end
