...
uicontrol('Units','normalized','Position',[0.22 0.315 0.05 0.05],'Style','popupmenu',...
    'Max',length(ch),'Min',1,'String',str','Tag','channels1','Value',showidx(1),'Callback',@chimch);

uicontrol('Units','normalized','Position',[0.22 0.23 0.05 0.05],'Style','popupmenu',...
    'Max',length(ch),'Min',1,'String',str','Tag','channels2','Value',showidx(2),'Callback',@chimch);

uicontrol('Units','normalized','Position',[0.22 0.14 0.05 0.05],'Style','popupmenu',...
    'Max',length(ch),'Min',1,'String',str','Tag','channels3','Value',showidx(3),'Callback',@chimch);

uicontrol('Units','normalized','Position',[0.22 0.06 0.05 0.05],'Style','popupmenu',...
...
% video params
% ------------------------------
uicontrol('Units','normalized','Position',[0.76 0.95 0.08 0.03],'Style','text',...
    'String','Frame interval (ms)','HorizontalAlignment','right','Enable','on');

uicontrol('Units','normalized','Position',[0.85 0.96 0.06 0.03],'Style','edit',...
...
for i=1:13
    ...
    disp(vstr)
    uicontrol('Units','normalized','Position',[0.03 y 0.02 height],'Style','checkbox',...
        'Tag',['instrumentchk_' num2str(i)],'HorizontalAlignment','center','Value',chkv,...
        'Enable','on','callback',@use_instrument);
    uicontrol('Units','normalized','Position',[0.05 y 0.09 height],'Style','edit',...
        'Tag',['instrument' num2str(i)],'String',join(instr_range(instr,:),'-'),'HorizontalAlignment','center',...
        'Enable',enable);
    uicontrol('Units','normalized','Position',[0.14 y 0.09 height],'Style','edit',...
        'Tag',['instrument' num2str(i)],'String',vstr,'HorizontalAlignment','center',...
        'Enable',enable);
    uicontrol('Units','normalized','Position',[0.23 y 0.06 height],'Style','popupmenu',...
        'Tag',['instrument' num2str(i)],'String',instruments,'Value',instr,'HorizontalAlignment','center',...
        'Enable',enable);
end

nax = axes('units','normalized','Position',[0.02 0.05 0.18 0.60]);
...
uicontrol('Units','normalized','Position',[0.85 0.16 0.11 0.03],'Style','text',...
    'String','Video time window','HorizontalAlignment','center','Enable','on');

uicontrol('Units','normalized','Position',[0.9 0.33 0.06 0.03],'Style','edit',...
    'Tag','notegap','String','5','HorizontalAlignment',...
    'center','Enable','on');

uicontrol('Units','normalized','Position',[0.83 0.325 0.06 0.04],'Style','text',...
    'String','Minimum note gap (fr)','HorizontalAlignment','right','Enable','on',...
    'TooltipString','The minimum gap between notes');

uicontrol('Units','normalized','Position',[0.9 0.29 0.06 0.03],'Style','edit',...
    'Tag','harmonics','String','5','HorizontalAlignment',...
    'center','Enable','on');

uicontrol('Units','normalized','Position',[0.84 0.285 0.05 0.03],'Style','text',...
...
uicontrol('Units','normalized','Position',[0.9 0.25 0.06 0.03],'Style','edit',...
    'Tag','noteduration','String','0.7','HorizontalAlignment',...
    'center','Enable','on');

uicontrol('Units','normalized','Position',[0.84 0.245 0.05 0.03],'Style','text',...
    'String','duration (s)','HorizontalAlignment','right','Enable','on',...
    'TooltipString','Duration of each note.');


uicontrol('Units','normalized','Position',[0.9 0.14 0.06 0.03],'Style','edit',...
    'Tag','startframe','String',num2str(min(props.video.tm)),'HorizontalAlignment',...
    'center','Callback',@startstop,'Enable','on');

uicontrol('Units','normalized','Position',[0.85 0.135 0.04 0.03],'Style','text',...
    'String','start (s)','HorizontalAlignment','right','Enable','on');

uicontrol('Units','normalized','Position',[0.9 0.10 0.06 0.03],'Style','edit',...
    'Tag','stopframe','String',num2str(max(props.video.tm)),'Callback',@startstop,...
    'HorizontalAlignment','center','Enable','on');

uicontrol('Units','normalized','Position',[0.85 0.09 0.04 0.03],'Style','text',...
    'String','stop (s)','HorizontalAlignment','right','Enable','on');


uicontrol('Units','normalized','Position',[0.9 0.21 0.06 0.03],'Style','edit',...
    'Tag','movfr','String','30','HorizontalAlignment',...
    'center','Enable','on');

uicontrol('Units','normalized','Position',[0.83 0.205 0.06 0.03],'Style','text',...
...
uicontrol('Units','normalized','Position',[0.85 0.05 0.1 0.04],'Style','pushbutton',...
