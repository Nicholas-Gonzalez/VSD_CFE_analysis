function vsd_stacked_plotter_tsm(allVSD,ROIs,folder,trial,IntanSignals,IntanLabels)
...
% INPUTS: allVSD (matrix of VSD data with ROIs in columns and frames in
%   rows), ROIs (array of ROIs to be selected from VSD data), folder
%   (folder path of frame and .rhs file for particular experiment),
%   trial (name of experimental trial, shared across all files for
%   inputed trial in VSD data), IntanSignals (pre-determined selection
%   of chronologically ordered nerve signals to be plotted out of all
%   nerves in .rhs file), IntanLabels (manually-written nerve labels
%   for plotting purposes).  NOTE: IntanSignals and IntanLabels can be
%   ignored when calling function from driver, and 
%   "vsd_stacked_plotter_tsm" will ignore plotting nerve signals.
