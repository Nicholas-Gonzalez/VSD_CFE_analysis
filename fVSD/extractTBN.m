...
% USAGE: extractTBN
% DESCRIPTION: attempts, but fails, to read .tbn data generated by
%   Turbo-SM64.  Any data binary data read by this function is
%   incorrect, and the numbers generated are often well out of the
%   range of doubles in MATLAB.  This can cause multiple bugs.
